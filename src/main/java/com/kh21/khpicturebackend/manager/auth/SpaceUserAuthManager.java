package com.kh21.khpicturebackend.manager.auth;

import cn.hutool.core.io.resource.ResourceUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.kh21.khpicturebackend.manager.auth.model.SpaceUserAuthConfig;
import com.kh21.khpicturebackend.manager.auth.model.SpaceUserRole;
...
public class SpaceUserAuthManager {
    ...
    public List<String> getPermissionByRole(String spaceUserRole) {
        ...
        SpaceUserRole userRole = SPACE_USER_AUTH_CONFIG.getRoles()
                .stream()
                .filter(r -> spaceUserRole.equals(r))
                .findFirst()
                .orElse(null);
